                        ...
                        <div className="flex flex-col w-full">
                          ...
                          {fourniture_list.map(({ parsedItem }, i) => (                            
                            <div key={i} className="flex items-center justify-evenly">
                              ...
                              {/* image */}
                              <div className='w-1/5'><img className=" w-32 h-32 mb-3 p-3" src={parsedItem.id.charAt(0) === 'M' ? parsedItem.image : parsedItem.product_picture  } alt= {parsedItem.id.charAt(0) === 'M' ? parsedItem.nom : parsedItem.name_to_display}  /></div>
                              
                              {/* nom category etc*/}
                              <div className='w-3/4 ml-5 flex flex-col'>

                              <h2 className="text-left text-xl mb-3">                                
                                {parsedItem.id.charAt(0) === 'M' ? parsedItem.nom : parsedItem.category  }
                                </h2>

                              <h2 className="text-left text-xs ml-1 ">
                                ...
                                <button className=' text-pink-300 p-1 border rounded-2xl w-1/4 text-xs'> Produit - cher</button>                                                             
                                <button className=' ml-2 text-green-400 p-1 border rounded-2xl w-1/4 text-xs'>  Produit + cher</button>                                                                                           
                                <button className='ml-2 text-blue-300 p-1 border rounded-2xl text-xs'> Tout les produits</button> 
                                </div>)}
                              ...
                              {/* prix qtt supprimer*/}
                                ...
                                <div className='  w-1/5 flex flex-col justify-center items-center border rounded-2xl p-3 '>                                  
                                <div className=' flex'>
                            ...
                            <div className='text-s flex items-center  justify-center'> Qtt: 
                                        <input
                                          type="number"
                                        ...
                                        />
                             {/* bouton supprimer*/}
                             <button className="  rounded-2xl flex justify-center w-min p-2" >
...
<path d="M15.2464 11.0746C15.2876 10.6625 14.9869 10.2949 14.5747 10.2537C14.1626 10.2125 13.795 10.5132 13.7538 10.9254L13.2538 15.9254C13.2126 16.3375 13.5133 16.7051 13.9255 16.7463C14.3376 16.7875 14.7051 16.4868 14.7464 16.0746L15.2464 11.0746Z" fill="#1C274C"/>
                              ...
                              :
                              (
                              <div className='  w-1/5 flex flex-col justify-center items-center border rounded-2xl p-2 '>                                  
                              <div className=' flex'>
